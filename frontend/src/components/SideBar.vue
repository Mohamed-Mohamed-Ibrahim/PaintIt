<template>
  ...
  <div class="shapeBar">
    ...
    <div @click="showHideCircleOption">
      <img
        width="60"
        height="60"
    ...
    <div @click="showHideEllipseOption">
      <img
        width="60"
        height="60"
    ...
    <div @click="showHideTriangleOption">
      <img
        width="60"
        height="60"
    ...
    <div @click="showHideRectangleOption">
      <img
        width="60"
        height="60"
    ...
    <div @click="showHideSquareOption">
      <img
        width="60"
        height="60"
  ...
  <div class="save">
    <div class="saveXML" style="display: none"></div>
    <div class="saveJSON">
      <form class="saveForm">
        ...
        <label><input type="radio" name="save" value="BOTH" />BOTH </label
        ><br />
  ...
  <div class="load">
    <div class="loadXML" style="display: none"></div>
    <div class="loadJSON">
  ...
  <div class="sideBar">
    ...
    <div @click="showHideColorPalette">
      <img
        width="40"
        height="40"
  ...
  methods: {
    ...
    async saveData(e) {
      ...
      formData.forEach((value, key) => {
        if (value === "JSON") object["format"] = 1;
        else if (value === "XML") object["format"] = 2;
        else if (value === "BOTH") object["format"] = 3;
        else {
          object[key] = value;
        }
      });
          ...
          stage.on("mousedown", function () {
            if (newRectangle) {
              newRectangle.on("transformend", () => {
                const updatedWidth =
                  newRectangle.width() * newRectangle.scaleX();
                const updatedHeight =
                  newRectangle.height() * newRectangle.scaleY();
          ...
          stage.on("mousedown", function () {
            if (newEllipse) {
              newEllipse.on("transformend", () => {
                const updatedRadiusX =
                  newEllipse.radiusX() * newEllipse.scaleX();
                const updatedRadiusY =
                  newEllipse.radiusY() * newEllipse.scaleY();
      ...
      stage.on("click", function (e) {
        ...
        clickedShape.on("dragend", function () {
          if (clickedShape instanceof Konva.Circle) {
            ...
            const updatedRadiusX =
              clickedShape.radiusX() * clickedShape.scaleX();
            const updatedRadiusY =
              clickedShape.radiusY() * clickedShape.scaleY();
            ...
            clickedShape instanceof Konva.Line &&
            clickedShape.points().length === 6
          ) {
            ...
            const updatedRectangleData = {
              shape:
                clickedShape.width() === clickedShape.height()
                  ? "square"
                  : "rectangle",
              id: clickedShape.id(),
              x: clickedShape.position().x,
    ...
    drawTriangle: function () {
      ...
      stage.on("mousedown", function () {
        if (!point1) point1 = stage.getPointerPosition();
        else if (!point2) point2 = stage.getPointerPosition();
        else {
    ...
    showHideShapeBar: function () {
      ...
      if (colorPalette.style.opacity === "1") {
        ...
        if (shapeBar.style.left === "5%") shapeBar.style.left = "-2%";
        else shapeBar.style.left = "5%";
      }
    },
    ...
    showHideColorPalette: function () {
      ...
      if (shapeBar.style.left === "5%") {
        ...
        if (colorPalette.style.opacity === "1")
          colorPalette.style.opacity = "0";
        else colorPalette.style.opacity = "1";
      }
    },
    ...
    showHideLineOption: function () {
      ...
      if (circle.style.left === "12%") {
        ...
        if (line.style.left === "12%") line.style.left = "-11%";
        else line.style.left = "12%";
      }
    },
    ...
    showHideCircleOption: function () {
      ...
      if (line.style.left === "12%") {
        ...
        if (circle.style.left === "12%") circle.style.left = "-11%";
        else circle.style.left = "12%";
      }
    },
    ...
    showHideEllipseOption: function () {
      ...
      if (line.style.left === "12%") {
        ...
        if (ellipse.style.left === "12%") ellipse.style.left = "-11%";
        else ellipse.style.left = "12%";
      }
    },
    ...
    showHideTriangleOption: function () {
      ...
      if (line.style.left === "12%") {
        ...
        if (triangle.style.left === "12%") triangle.style.left = "-11%";
        else triangle.style.left = "12%";
      }
    },
    ...
    showHideRectangleOption: function () {
      ...
      if (line.style.left === "12%") {
        ...
        if (rectangle.style.left === "12%") rectangle.style.left = "-11%";
        else rectangle.style.left = "12%";
      }
    },
    ...
    showHideSquareOption: function () {
      ...
      if (line.style.left === "12%") {
        ...
        if (square.style.left === "12%") square.style.left = "-11%";
        else square.style.left = "12%";
      }
    },
  },
};
